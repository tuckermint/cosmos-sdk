...
func trimInternal(st errors.StackTrace) errors.StackTrace {
	...
	for matchesFunc(st[0],
		...
		"github.com/tuckermint/cosmos-sdk/types/errors.Wrap",
		"github.com/tuckermint/cosmos-sdk/types/errors.Wrapf",
		"github.com/tuckermint/cosmos-sdk/types/errors.WithType",
